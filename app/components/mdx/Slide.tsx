...
import {
  SlideSecondColumnContext,
  type SlideSecondColumnContextValue,
} from "./SlideSecondColumnContext";
...
export default function Slide({
  ...
  const ctx = useMemo<SlideSecondColumnContextValue>(
    () => ({
      register: (content: ReactNode, width: string) =>
        setSecondCol({ content, width }),

...
export default function KImage({
    ...
    const computeAutoLayout = useCallback(() => {
        ...
        const containerEl = (
            wrapper.closest('.slide-second-col-content') ??
            wrapper.closest('.slide-main-content') ??
            wrapper.closest('.slide-layout-vertical')
        ) as HTMLElement | null
    ...
    useEffect(() => {
        ...
        const run = () => requestAnimationFrame(() => requestAnimationFrame(computeAutoLayout))
    ...
    useEffect(() => {
        ...
        const ro = new ResizeObserver(() => requestAnimationFrame(computeAutoLayout))
        ro.observe(section)

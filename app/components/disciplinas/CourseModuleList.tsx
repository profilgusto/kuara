...
import { BookOpen, FlaskConical, ClipboardCheck, FileText, LayoutList, Rows3 } from 'lucide-react'
...
export function CourseModuleList({ modules, courseSlug }: CourseModuleListProps) {

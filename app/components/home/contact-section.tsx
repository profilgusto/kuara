    ...
    <section id="contato" ref={ref} className="py-24 px-6">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
        ...
        <div>
          ...
          <h2
            className="reveal opacity-0 mt-3 text-display-md font-sans font-semibold text-foreground leading-tight"
            style={{ animationDelay: "60ms" }}
          >
            Vamos colaborar
          </h2>
          <p
            className="reveal opacity-0 mt-4 text-muted-foreground max-w-[48ch] leading-[1.7]"
            style={{ animationDelay: "120ms" }}
          >
            Seja para parcerias de pesquisa, aplicações de tecnologia ou
            simplesmente troca de conhecimento — nossa equipe está aberta ao
            diálogo.
          </p>
          ...
          >
            {[
              ...
              >
                <Icon
                  size={15}
                  className="text-primary-DEFAULT flex-shrink-0"
                />
                <span>{label}</span>
              </div>
            ))}
          ...
          {sent ? (
            ...
            >
              ...
              >
                ...
                <Send
                  size={14}
                  className="ml-2 transition-transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5 duration-240"
                />
              </Button>
            </form>
          )}

...
export function GradingClient({
    ...
    function getStudentScore(studentId: string, activityId: string): number | null {
    ...
    function updateScore(
        ...
        setScores((prev) => {
            const key =
                entityType === 'student'
                    ? (s: Score) => s.activityId === activityId && s.studentId === entityId
    ...
    return (
        <div className="space-y-8">
            ...
            <section>
                ...
                {/* Weight summary */}
                <div
                    className={`flex items-center gap-2 px-3 py-2 rounded-lg text-sm mb-4 ${weightValid
                ...
                <section>
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="flex items-center gap-2">
                            <button
                                ...
                                className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-md text-xs font-medium transition-colors ${editing
                    ...
                    {!weightValid && (
                        <p className="text-xs text-amber-600 dark:text-amber-400 mt-2 flex items-center gap-1">
                            ...
                            A nota final só será calculada corretamente quando os pesos somarem
                            10.0
                        </p>
                    )}
                </section>

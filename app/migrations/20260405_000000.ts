...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  await db.execute(sql`ALTER INDEX IF EXISTS "cadernos_rels_order_idx"       RENAME TO "tesselas_rels_order_idx";`)
  await db.execute(sql`ALTER INDEX IF EXISTS "cadernos_rels_parent_id_idx"   RENAME TO "tesselas_rels_parent_id_idx";`)
  await db.execute(sql`ALTER INDEX IF EXISTS "cadernos_rels_path_idx"        RENAME TO "tesselas_rels_path_idx";`)
  ...
  await db.execute(sql`ALTER INDEX IF EXISTS "cadernos_versions_version_slug_idx" RENAME TO "tesselas_versions_version_slug_idx";`)
  await db.execute(sql`ALTER INDEX IF EXISTS "cadernos_versions_created_at_idx"   RENAME TO "tesselas_versions_created_at_idx";`)
  await db.execute(sql`ALTER INDEX IF EXISTS "cadernos_versions_updated_at_idx"   RENAME TO "tesselas_versions_updated_at_idx";`)
